...
export default function ManageSubject({ me }) {
  ...
  // Reset pagination when search query or program selection changes
  useEffect(() => {
    setCurrentPage(1);
  ...
  const paginatedTags = filteredTags.slice(startIndex, startIndex + PAGE_SIZE);
