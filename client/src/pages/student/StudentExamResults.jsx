...
function getStatusMeta(status) {
  switch (status) {
    ...
    case 'near_pass':
      return { label: 'Near Pass', color: '#d97706', bg: '#fffbeb', border: '#fde68a' };
    case 'failed':
          ...
          <div className="ser-detail-view">
            ...
            <div className="ser-report-header">
              ...
              <div className="ser-report-meta">
                <span className="ser-report-date">Date Taken: {formatDate(selectedAttempt.date)}</span>
              ...
              <div className="ser-hero-metrics">
                ...
                <div className="ser-metric-item">
                  <span className="m-value">
                    {new Date(selectedAttempt.date).toLocaleDateString('en-US', {
                      month: 'short',
                      day: 'numeric',
                      year: 'numeric',
                    })}
                      ...
                      <div className="ae-card-body ser-result-card-body">
                        <div className="ser-result-card-top">
                          <div className="ser-result-heading">
                            ...
                            <div className="ae-subtitle ser-result-date">{formatDate(attempt.date)}</div>
                          </div>
